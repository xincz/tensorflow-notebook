...
if __name__ == "__main__":
    ...
    x2 = 3 * np.eye(3)
    my_assert(distance(x1, x2, pair=True, dist_type="euclidean2"),
              np.array([[9., 9., 9.],
                       [5., 5., 17.],
                       [5., 17., 5.],
                       [17., 5., 5.]]))
    my_assert(distance(x1, x2, pair=True, dist_type="normed_euclidean2"),
    ...
    my_assert(distance(x1, x1[::-1], pair=False, dist_type="normed_euclidean2"),
              np.array([0.36700684, 1., 1., 0.36700684]))
    my_assert(distance(x1, x1[::-1], pair=False, dist_type="cosine"),
